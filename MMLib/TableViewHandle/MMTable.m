...
{
    if (MMCheckArrayInRange(index, _sections))
    {
...
{
    if (MMCheckArrayInRange(indexPath.section, _sections) && MMCheckUsignNumberUnder(indexPath.row, [_sections[indexPath.section] numberOfRows]+1))    {
...
{
    if (MMCheckArrayInRange(indexPath.section, _sections) && MMCheckUsignNumberUnder(indexPath.row, [_sections[indexPath.section] numberOfRows]))
    {
...
{
    __block BOOL containt = MMCheckArrayInRange(indexPath.section, _sections);
    if (containt)
    {
        containt = MMCheckArrayInRange(indexPath.row, [_sections[indexPath.section] rows]);
    }
    return containt;
}
...
{
    if (MMCheckArrayInRange(index, _rows))
    {
