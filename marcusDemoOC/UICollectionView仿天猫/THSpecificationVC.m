...
- (void)initView{
    ...
    UINib *countNib = [UINib nibWithNibName:@"THSpecificationCountView" bundle:[NSBundle mainBundle]];
    [_collectionView registerNib:countNib forSupplementaryViewOfKind:UICollectionElementKindSectionFooter
             withReuseIdentifier:@"THSpecificationCountView"];
}
...
-(CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout referenceSizeForFooterInSection:(NSInteger)section{
    if (_specificationArray.count-1 == section) {
...
//        if (indexPath.section == _specificationArray.count-1) {
//            THSpecificationCountView *footerView = (THSpecificationCountView*)[collectionView dequeueReusableSupplementaryViewOfKind:UICollectionElementKindSectionFooter withReuseIdentifier:@"THSpecificationCountView" forIndexPath:indexPath];
//            return footerView;
//        }else{
